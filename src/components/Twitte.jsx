        ...
        <>
            <section className='flex border-solid border border-gray-300 px-2 '>
                ...
                <div className='ms-2 w-full mb-0.5' >
                    <Titre stylerdiv='flex' styleSpan1={styleSpan1} titleSpan1={twitte.source} src='src/images/bagdgetPro.svg' styleSpan2='text-slate-400' titleSpan2={twitte.source} date={twitte.date} />
